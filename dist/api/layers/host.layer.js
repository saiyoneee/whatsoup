...
var HostLayer = /** @class */ (function () {
    function HostLayer(page, session, options) {
        this.page = page;
        this.spinnies = spinnies_1.getSpinnies();
        this.spinStatus = {
            apiInject: '',
            autoCloseRemain: 0,
            previousText: '',
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, browser_1.injectApi(page)
                                .then(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, auth_1.retrieveQR(this.page).catch(function () { return undefined; })];
                    case 2:
                        qrResult = _a.sent();
                        _a.label = 3;
    ...
    HostLayer.prototype.waitForInChat = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, auth_1.isInsideChats(this.page)];
                    case 1:
                        inChat = _a.sent();
                        _a.label = 2;
                    case 2:
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, auth_1.isInsideChats(this.page)];
                    case 4:
                        inChat = _a.sent();
                        return [3 /*break*/, 2];
