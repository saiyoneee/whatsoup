...
function deleteFiles(mergedOptions, Session, spinnies) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            pathTokens = path.join(path.resolve(process.cwd() + mergedOptions.mkdirFolderToken, mergedOptions.folderNameToken), Session + ".data.json");
            if (fs_1.existsSync(pathTokens)) {
                fs_1.unlink(pathTokens, function (err) {
                    if (err) {
